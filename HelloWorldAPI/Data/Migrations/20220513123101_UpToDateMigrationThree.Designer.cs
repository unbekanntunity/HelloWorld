...
namespace HelloWorldAPI.Data.Migrations
{
    ...
    [Migration("20220513123101_UpToDateMigrationThree")]
    partial class UpToDateMigrationThree
    {
            ...
            modelBuilder.Entity("HelloWorldAPI.Domain.Database.Reply", b =>
                {
                    ...
                    b.HasOne("HelloWorldAPI.Domain.Database.Reply", "RepliedOn")
                        .WithMany("Replies")
                        .HasForeignKey("RepliedOnId");

                    b.Navigation("Creator");

                    b.Navigation("RepliedOn");
                });
