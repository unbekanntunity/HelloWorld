...
namespace HelloWorldAPI.Data.Migrations
{
    ...
    [Migration("20220516120403_AddNullableDescriptionUser")]
    partial class AddNullableDescriptionUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HelloWorldAPI.Domain.Database.Reply", b =>
                {
                    ...
                    b.HasOne("HelloWorldAPI.Domain.Database.Article", "RepliedOnArticle")
                        .WithMany("Replies")
                        .HasForeignKey("RepliedOnArticleId");

                    b.HasOne("HelloWorldAPI.Domain.Database.Comment", "RepliedOnComment")
                        .WithMany("Replies")
                        .HasForeignKey("RepliedOnCommentId");

                    b.HasOne("HelloWorldAPI.Domain.Database.Reply", "RepliedOnReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("ReplyUser", b =>
                {
                    b.HasOne("HelloWorldAPI.Domain.Database.Reply", null)
                        .WithMany()
            ...
            modelBuilder.Entity("HelloWorldAPI.Domain.Database.User", b =>
                {
                    b.HasOne("HelloWorldAPI.Domain.Database.Message", null)
                        .WithMany("UserLiked")
