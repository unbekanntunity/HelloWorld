...
namespace HelloWorldAPI.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public ProjectService(IProjectRepository projectRepository, IIdentityService identityService, ITagService tagService, INonQueryRepository<Project> nonQueryRepository)
        {
        ...
        public async Task<Result<Project>> CreateAsync(Project project, IEnumerable<string> memberIds, IEnumerable<string> tagNames)
        {
